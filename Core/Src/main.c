...
/* --- RECONFIGURE BUTTON TO TRIGGER ON BOTH EDGES --- */

// On Nucleo G474RE, the blue button is on PC13.

// After BSP_PB_Init, the EXTI line is set to rising edge only.

// Change it to both edges.

GPIO_InitTypeDef gpio_init;

gpio_init.Pin = GPIO_PIN_13;

gpio_init.Mode = GPIO_MODE_IT_RISING_FALLING; // both edges
...
// Also reconfigure the EXTI to trigger on both edges
